...
class configs():
    ...
    def __init__(self,model_dataset='COCO'):
        ...
        if self.model_params['model_algorithm'] == 'YOLOv5':
            ...
            self.model_params['model_path'] = [os.path.join('models_weights', 'yolov5-LP_best.pt')]
        ...
        self.COCO_dataset_params['images_dir'] = r'D:\SEONGJIN\185.CCTV 기반 차량정보 및 교통정보 계측 데이터\01-1.정식개방데이터\dataset_lp_small\images\val'
        self.COCO_dataset_params['annotations_path'] = r'D:\SEONGJIN\185.CCTV 기반 차량정보 및 교통정보 계측 데이터\01-1.정식개방데이터\dataset_lp_small_val\annotations\annotations.json'
        self.COCO_dataset_params['objects_count_path'] = r'D:\SEONGJIN\185.CCTV 기반 차량정보 및 교통정보 계측 데이터\01-1.정식개방데이터\dataset_lp_small_val\objects_count\objects_count.csv'
