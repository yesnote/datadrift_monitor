...
from OD_models.Faster_RCNN.generalized_rcnn import GeneralizedRCNN
from torchvision.models.detection.roi_heads import RoIHeads
from OD_models.Faster_RCNN.rpn import RegionProposalNetwork, RPNHead
...
__all__ = [
    ...
    "fasterrcnn_resnet50_fpn_v2_local",
    "fasterrcnn_mobilenet_v3_large_fpn_local",
    "fasterrcnn_mobilenet_v3_large_320_fpn_local",
]
...
def fasterrcnn_resnet50_fpn_local(
    *,
    ...
    **kwargs: Any,
    ...
    Adversarial_detection with Region Proposal Networks <https://arxiv.org/abs/1506.01497>`__
    paper.
...
def fasterrcnn_resnet50_fpn_v2_local(
    *,
    ...
    **kwargs: Any,
    ...
    """
    Constructs an improved Faster R-CNN model with a ResNet-50-FPN backbone from `Benchmarking Adversarial_detection
...
def fasterrcnn_mobilenet_v3_large_320_fpn_local(
    *,
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.fasterrcnn_mobilenet_v3_large_320_fpn_local(weights=FasterRCNN_MobileNet_V3_Large_320_FPN_Weights.DEFAULT)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
...
def fasterrcnn_mobilenet_v3_large_fpn_local(
    *,
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.fasterrcnn_mobilenet_v3_large_fpn_local(weights=FasterRCNN_MobileNet_V3_Large_FPN_Weights.DEFAULT)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
