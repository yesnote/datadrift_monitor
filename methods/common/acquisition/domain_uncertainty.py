'''Domain diversity and detection entropy shared by active DA methods.'''
...
def compute_foreground_entropy(
    ...
    '''Average foreground-class entropy over post-NMS detections.'''
...
def compute_domain_diversity_score(
    ...
    '''Compute AADA's target-likeness importance weight ``(1-D)/D``.'''
