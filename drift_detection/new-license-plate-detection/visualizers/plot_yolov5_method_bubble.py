...
METHOD_RUNS = [
    {
        ...
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;12_score",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_12;25_score",
        "input_dim": 1,
    },
    {
        "label": "Class Prob.",
        "method_type": "Deterministic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;12_class_probability",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_12;26_class_probability",
        "input_dim": 80,
    },
    {
        "label": "Entropy",
        "method_type": "Deterministic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;12_entropy",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_12;28_entropy",
        "input_dim": 1,
    },
    {
        "label": "Energy",
        "method_type": "Deterministic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;12_energy",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_12;29_energy",
        "input_dim": 1,
    },
    {
        "label": "MC Dropout",
        "method_type": "Stochastic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;41_mc_dropout",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_12;52_mc_dropout",
        "input_dim": 88,
    },
    {
        "label": "MetaDetect",
        "method_type": "Deterministic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/05-27-2026_12;54_meta_detect",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_13;14_meta_detect",
        "input_dim": 121,
    },
    {
        "label": "NullDetect",
        "method_type": "Deterministic",
        "od_run": r"object_detectors/runs/yolov5/predict/coco/06-01-2026_00;19_null_detect",
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/06-01-2026_00;39_null_detect",
        "input_dim": 88,
    },
    {
        ...
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_13;17_layer_grad_grid",
        "input_dim": 54,
        "grid_filter": {
            "target": "cand_target",
            "bbox_loss": "box_l1",
    ...
    },
    {
        ...
        "method_type": "Gradient",
        "od_runs": [
            r"object_detectors/runs/yolov5/predict/coco/05-27-2026_13;17_layer_grad_grid/05-27-2026_16;12_layer_grad_t-null__term-bbox__b-box_l1-pred",
            r"object_detectors/runs/yolov5/predict/coco/05-27-2026_13;17_layer_grad_grid/05-27-2026_17;10_layer_grad_t-null__term-cls__c-kl-pred",
            r"object_detectors/runs/yolov5/predict/coco/05-27-2026_13;17_layer_grad_grid/05-27-2026_17;43_layer_grad_t-null__term-obj__o-bce-pred",
        ],
        "meta_run": r"meta_models/meta_classifier/runs/yolov5/train/coco/05-27-2026_13;17_layer_grad_grid",
        "input_dim": 54,
        "grid_filter": {
