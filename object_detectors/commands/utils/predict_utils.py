...
def parse_output_config(output_cfg):
    ...
    if layer_grad_image_normalize not in {"layer_minmax", "overall_minmax", "none"}:
        raise ValueError("output.save_image.layer_grad.normalize must be 'layer_minmax', 'overall_minmax', or 'none'.")
